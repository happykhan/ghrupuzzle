...
const AssemblyExercise: React.FC<{ samples: Sample[], speciesList: string[], samplesheet: { url: string }, assembly_type: string}> = ({ samples, speciesList, samplesheet, assembly_type }) => {
    return (
        <div>
            ...
            <ul>
            <li>If a sample is potentially contaminated with multiple species, report &quot;CONTAMINATED&quot; in the tax_classification column.</li>
...
function GenomeAssemblyQC() {
    const columns = [
      ...
      { name: "tax_classification", description: "The species of the genome, as assessed by YOU." },
